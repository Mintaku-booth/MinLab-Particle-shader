/****************************************
var       作成日      作成者 履歴
var 1.0   2026/03/24  民たく 新規作成
参考URL：https://github.com/edom18/BubbleShader
******************************************/

Shader "Custom/MinLPS_BubbleShader"
{
	Properties
	{
	...
	SubShader
	{
        ...
        void vert (inout appdata_full v, out Input o)
        {
			...
			float3 waveStartFactor = saturate((objScale - _WaveThresholdSize.xxx)/max(_WaveThresholdSizeGradient, 0.00001f));
